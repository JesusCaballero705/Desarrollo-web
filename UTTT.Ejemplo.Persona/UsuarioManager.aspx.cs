...
namespace UTTT.Ejemplo.Persona
{
    public partial class UsuarioManager : System.Web.UI.Page
    {
        ...
        {
            using (SqlConnection conn = new SqlConnection("Data Source=BDPersona.mssql.somee.com;Initial Catalog=BDPersona;User ID=JesusCaballero_SQLLogin_1;Password=r7iywl7tlz"))
            {
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=BDPersona.mssql.somee.com;Initial Catalog=BDPersona;User ID=JesusCaballero_SQLLogin_1;Password=r7iywl7tlz");
